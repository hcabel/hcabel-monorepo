...
class CookieManager {
	...
	public static setCookie(name: string, value: string, options?: Cookies.CookieAttributes) {
	...
	public static removeCookie(name: string, options?: Cookies.CookieAttributes) {
