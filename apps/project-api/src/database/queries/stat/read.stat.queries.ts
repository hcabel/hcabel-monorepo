 ...
 */
export function read(filter: Partial<IStatModel>): Promise<IStatModel[] | null>
{
	return (
		Stat.table
			.find(filter)
 ...
 */
export function read_single(filter: Partial<IStatModel & Dotnation>): Promise<IStatModel | null>
{
	return (
		Stat.table
			.findOne(filter)
